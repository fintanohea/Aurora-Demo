export const customTooltip: string =
  '<div>' +
  '<div style="padding: 16px; 16px; display: flex; align-items: center;"> <div style="width: 8px; height: 8px; border-radius: 50%; background-color: #ff9e18"></div><span style="color: #4A4A4A; margin-left: 8px">' + 'mobile' + '</span></div>' +
